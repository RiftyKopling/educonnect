<x-app-layout>
    <div class="flex items-center gap-2 text-sm text-gray-500 mb-4">
        ...
        <span>›</span>
        <span class="text-[#03045E] font-bold">Unggah Baru</span>
    </div>

    <div class="mb-6">
        <h2 class="text-3xl font-black text-[#03045E] tracking-tight uppercase">Unggah Materi Baru</h2>
    </div>
    ...
    <div class="bg-white rounded-[2rem] shadow-sm p-8 border border-gray-100 max-w-2xl">
        ...
        <form action="{{ route('materi-ajar.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="judul" required class="w-full bg-gray-50 border border-gray-200 text-[#03045E] rounded-2xl p-4 focus:ring-4 focus:ring-[#03045E]/20 focus:border-[#03045E] transition-all font-medium" placeholder="Misal: Modul Aljabar Dasar Pertemuan 1">
            </div>
