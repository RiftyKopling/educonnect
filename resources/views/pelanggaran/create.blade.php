    ...
    <div class="max-w-3xl mx-auto">
        <div class="mb-8">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
                ...
                <span>›</span>
                <span class="text-[#03045E] font-bold">Tambah Pelanggaran</span>
            </div>
            ...
            <!-- Header -->
            <h2 class="text-3xl font-black text-[#03045E] tracking-tight">Tambah Pelanggaran</h2>
            <p class="text-gray-500 text-sm mt-1">Tambahkan pelanggaran baru beserta kategorinya.</p>
        </div>
        ...
        @if($errors->any())
            <div class="mb-6 p-4 bg-red-50 border border-red-400 text-red-700 rounded-2xl">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <span class="font-bold">Proses Tambah Pelanggaran Dibatalkan, terdapat {{ $errors->count() }} kesalahan:</span>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" 
                            rows="3" 
                            class="w-full rounded-2xl border-gray-200 focus:ring-[#03045E] focus:border-[#03045E] p-4">{{ old('deskripsi') }}</textarea>
