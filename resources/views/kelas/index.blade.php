<x-app-layout>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-500">Mengelola data kelas dan penetapan wali kelas secara terpusat.</p>
        </div>
                ...
                <tr class="bg-gray-50 hover:bg-gray-100 transition-all">
                    ...
                    <td class="p-4 rounded-r-2xl text-center">
                        <div class="flex justify-center gap-2">
                            ...
                            <a href="{{ route('kelas.show', $kelas->id) }}" class="p-2 bg-blue-100 text-blue-600 rounded-xl hover:bg-blue-200 transition-colors" title="Lihat Daftar Siswa">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                            </a>
                            <a href="{{ route('kelas.edit', $kelas->id) }}" class="p-2 bg-amber-100 text-amber-600 rounded-xl hover:bg-amber-200 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
