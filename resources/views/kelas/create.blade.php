<x-app-layout>
    <div class="max-w-4xl mx-auto">
        <div class="mb-8">
            ...
            <h2 class="text-3xl font-black text-[#03045E] tracking-tight uppercase">Tambah Kelas Baru</h2>
        </div>
            ...
            <form action="{{ route('kelas.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <input type="text" name="nama_kelas" value="{{ old('nama_kelas') }}" class="w-full rounded-2xl border-gray-100 bg-gray-50 p-4 focus:ring-2 focus:ring-[#03045E] focus:bg-white transition-all font-bold" placeholder="Contoh: 7A">
                    ...
                    <div>
                        ...
                        <input type="text" name="tahun_ajaran" value="{{ old('tahun_ajaran') }}" class="w-full rounded-2xl border-gray-100 bg-gray-50 p-4 focus:ring-2 focus:ring-[#03045E] focus:bg-white transition-all font-bold" placeholder="2025/2026">
                        @error('tahun_ajaran') <p class="text-red-500 text-xs mt-2 font-bold">{{ $message }}</p> @enderror
                    </div>

                    <div>
                        <label class="block text-xs font-black text-[#03045E] mb-3 uppercase tracking-[0.2em]">Pilih Wali Kelas</label>
