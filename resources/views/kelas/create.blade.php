    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
                ...
                <span>›</span>
                <span class="text-[#03045E] font-bold">Tambah Kelas Baru</span>
            </div>
        ...
        @if($errors->any())
            <div class="mb-6 p-4 bg-red-50 border border-red-400 text-red-700 rounded-2xl">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <span class="font-bold">Proses Tambah Kelas Dibatalkan, terdapat {{ $errors->count() }} kesalahan:</span>
                </div>
            ...
            <form action="{{ route('kelas.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-[#03045E] mb-2 uppercase tracking-widest">Pilih Wali Kelas</label>
